<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="whychoose.aspx.cs" Inherits="ad_single_article" %>
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">
                                Thông Tin Tại Sao Chọn Chúng Tôi</h3>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td runat="server">
                                        ...
                                        <span class="required">(Kích thước 136px x 136px)</span>
                                    </td>
                                </tr>
                                <tr>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ArticleSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="12" Name="ArticleCategoryID" PropertyName="SelectedValue"
                Type="String" />
