<%@ Page Title="" Language="C#" MasterPageFile="~/site-sub.master" AutoEventWireup="true"
    CodeFile="san-pham-sub.aspx.cs" Inherits="san_pham" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="wrap-pro">
        <div class="container">
            <div class="col-aside">
                <div class="box-aside">
                    <asp:ListView ID="lstProductClothes" runat="server" DataSourceID="odsProductClothes"
                        ...
                        <LayoutTemplate>
                            <ul class="menu-list menu-iconr">
                                <li><a href="javascript:void(0);">Mẫu áo thun</a>
                                    <ul class="menu-ma">
                    ...
                    <asp:ObjectDataSource ID="odsProductClothes" runat="server" SelectMethod="ProductCategorySelectAll"
                ...
                <div class="slider-sub">
                    <div id="sliderBanner">
                        <asp:ListView ID="lstBannerProduct" runat="server" DataSourceID="odsBannerProduct"
                            ...
                            <ItemTemplate>
                                <div class="slide">
                                    <img id="Img2" alt='<%# Eval("FileName") %>' src='<%# !string.IsNullOrEmpty(Eval("FileName").ToString()) ? "~/res/advertisement/" + Eval("FileName") : "~/assets/images/slider-img-1.jpg" %>'
                                        runat="server" /></div>
                            </ItemTemplate>
                            <LayoutTemplate>
                ...
                <div class="product-wrap">
                    <div class="text-center wrapper-880">
                        ...
                        <asp:ObjectDataSource ID="odsContentProductCategory" runat="server" SelectMethod="ProductCategorySelectOne"
                            TypeName="TLLib.ProductCategory">
                            <SelectParameters>
                                <asp:QueryStringParameter Name="ProductCategoryID" QueryStringField="psi" Type="String" />
                            </SelectParameters>
                        </asp:ObjectDataSource>
                    </div>
                    <div class="product-group row">
                            ...
                            <ItemTemplate>
                                <div class="col-md-4 col-xs-6 element-item">
                                    <div class="product-box">
                                        <a href='<%# progressTitle(Eval("ProductName")) + "-psi-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>'
                                            class="product-img fullbox-img">
                                            <img id="Img1" class="hideo" alt='<%# Eval("ImageName") %>' src='<%# !string.IsNullOrEmpty(Eval("ImageName").ToString()) ? "~/res/product/" + Eval("ImageName") : "~/assets/images/img-product-1.jpg" %>'
                                                runat="server" /></a>
                        ...
                        <asp:ObjectDataSource ID="odsProduct" runat="server" SelectMethod="ProductSelectAll"
                            ...
                            <SelectParameters>
                                ...
                                <asp:QueryStringParameter Name="CategoryID" QueryStringField="psi" Type="String" />
