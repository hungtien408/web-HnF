<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="tu-van.aspx.cs" Inherits="tu_van" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" Runat="Server">
    <div id="banner" class="banner-ser">
        <div class="slider-wrapper">
            <h2 class="title-tv"><span>Tư vấn</span></h2>
            <img class="img-responsive" src="assets/images/banner-suicide.jpg" alt="" />
        </div>
    </div>
    <div class="header-services header-tv display-none">
        <div class="container">
            <div class="logo">
        ...
        <div class="productw">
            <div class="section-tb row">
                ...
                <div class="col-lg-4 col-xs-6 element-item">
                    <div class="box-suicide">
                        <a href="#" class="suicide-img">
                            <img src="assets/images/suicide-img-2.jpg" alt="" class="corner" />
                        </a>
                        <h4 class="title-suicide">
                            <a href="#">Dịch vụ khách hàng hoàn hảo</a></h4>
                        <div class="description">
                ...
                <div class="col-lg-4 col-xs-6 element-item">
                    <div class="box-suicide">
                        <a href="#" class="suicide-img">
                            <img src="assets/images/suicide-img-3.jpg" alt="" class="corner" />
                        </a>
                        <h4 class="title-suicide">
                            <a href="#">Dịch vụ khách hàng hoàn hảo</a></h4>
                        <div class="description">
                ...
                <div class="col-lg-4 col-xs-6 element-item">
                    <div class="box-suicide">
                        <a href="#" class="suicide-img">
                            <img src="assets/images/suicide-img-4.jpg" alt="" class="corner" />
                        </a>
                        <h4 class="title-suicide">
                            <a href="#">Dịch vụ khách hàng hoàn hảo</a></h4>
                        <div class="description">
                ...
                <div class="col-lg-4 col-xs-6 element-item">
                    <div class="box-suicide">
                        <a href="#" class="suicide-img">
                            <img src="assets/images/suicide-img-5.jpg" alt="" class="corner" />
                        </a>
                        <h4 class="title-suicide">
                            <a href="#">Dịch vụ khách hàng hoàn hảo</a></h4>
                        <div class="description">
                ...
                <div class="col-lg-4 col-xs-6 element-item">
                    <div class="box-suicide">
                        <a href="#" class="suicide-img">
                            <img src="assets/images/suicide-img-6.jpg" alt="" class="corner" />
                        </a>
                        <h4 class="title-suicide">
                            <a href="#">Dịch vụ khách hàng hoàn hảo</a></h4>
                        <div class="description">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-xs-6">
                <h4 class="title-footer text-uppercase">
                    Chúng tôi có thể là đối tác bạn đang tìm kiếm</h4>
                <p class="footer-content">
                    Hãy để chúng tôi cho bạn những lời khuyên và giải pháp tốt nhất cho nhu cầu của
                    bạn!</p>
            </div>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphMenuMobile" Runat="Server">
    <!--menumobile-->
